...
SECRET_KEY = 'django-insecure-@tzt-s*59+xn+3!n83w0e@kdy316m@)(t@de5$w&h9-c@k7l^h'
...
EMAIL_USE_TLS = getenv('EMAIL_USE_TLS', None)
EMAIL_USE_SSL = getenv('EMAIL_USE_SSL', None)
